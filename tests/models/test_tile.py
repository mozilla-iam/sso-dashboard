...
from dashboard.models.tile import CDNTransfer, urllib3
...
def test_download_config(mocker, cdn_transfer):
    ...
    mocker.patch.object(urllib3.PoolManager, 'request', return_value=mock_response)
    mock_open_yml = mocker.patch("builtins.open", mocker.mock_open())
    mock_open_yml.return_value.fileno.return_value = 3
    mock_open_etag = mocker.patch("builtins.open", mocker.mock_open())
