...
def externals(monkeypatch):
    ...
    monkeypatch.setenv("SSO_DASHBOARD_REDIS_CONNECTOR", "foobar")
    monkeypatch.setenv("SSO_DASHBOARD_SECRET_KEY", "deadbeef")
    monkeypatch.setenv("SSO_DASHBOARD_S3_BUCKET", "")
    monkeypatch.setenv("SSO_DASHBOARD_FORBIDDEN_PAGE_PUBLIC_KEY", "")
    monkeypatch.setenv("SSO_DASHBOARD_CDN", "https://localhost")
